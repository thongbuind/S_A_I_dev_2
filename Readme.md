...
*Từ test 1 đến test 11 là kiểm tra kiến thức lịch sử, yêu cầu phân biệt huý danh/miếu hiệu/thuỵ hiệu/tôn hiệu/thân thế của các vị hoàng đế.*
...
### Test 1
**Input:** hoàng đế thứ hai của triều đại nhà lý là
...
### Test 2
**Input:** lý công uẩn có miếu hiệu là
...
### Test 3
**Input:** lý phật mã là tên thật của hoàng đế
...
### Test 5
**Input:** thánh tông hoàng đế của triều đại nhà lý là
...
### Test 9
**Input:** thái tổ cao hoàng đế là thuỵ hiệu của
...
### Test 10
**Input:** lê bang cơ có miếu hiệu là
...
### Test 11
**Input:** thánh tông thuần hoàng đế là
...
### Test 19
**Input:** sau khi ăn xong, chúng tôi
